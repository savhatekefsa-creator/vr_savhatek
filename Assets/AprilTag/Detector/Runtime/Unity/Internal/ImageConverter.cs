...
namespace AprilTag
{
    ...
    {
        public static unsafe void Convert(ReadOnlySpan<Color32> data, ImageU8 image)
        {
        ...
        [BurstCompile]
        static unsafe void BurstConvert(Color32* src, byte* dst, int width, int height, int stride)
        {
            var offs_src = 0;
