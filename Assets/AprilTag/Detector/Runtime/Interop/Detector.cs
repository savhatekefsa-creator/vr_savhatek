...
namespace AprilTag.Interop
{
    public sealed class Detector : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        unsafe ref InternalData Data => ref Util.AsRef<InternalData>((void*)handle);
        ...
        {
            get => Data.nthreads;
            set => Data.nthreads = value;
        }

        public float QuadDecimate
        {
            get => Data.quad_decimate;
            set => Data.quad_decimate = value;
        }

        public float QuadSigma
        {
            get => Data.quad_sigma;
            set => Data.quad_sigma = value;
        }

        public int RefineEdges
        {
            get => Data.refine_edges;
            set => Data.refine_edges = value;
        }

        public double DecodeSharpening
        {
            get => Data.decode_sharpening;
            set => Data.decode_sharpening = value;
        }

        public bool Debug
        {
            get => Data.debug != 0;
            set => Data.debug = value ? 1 : 0;
        }

        public unsafe ref TimeProfile TimeProfile => ref Util.AsRef<TimeProfile>((void*)Data.tp);

        public static Detector Create() => _Create();

        public void AddFamily(Family family) => _AddFamilyBits(this, family, 2);

        public void RemoveFamily(Family family) => _RemoveFamily(this, family);

        public DetectionArray Detect(ImageU8 image) => _Detect(this, image);
