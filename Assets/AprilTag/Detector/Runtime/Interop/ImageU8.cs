...
namespace AprilTag.Interop
{
    public sealed class ImageU8 : SafeHandleZeroOrMinusOneIsInvalid
    {
        ...
        public unsafe Span<byte> Buffer => new Span<byte>((void*)Data.buf, Stride * Height);

        public static ImageU8 Create(int width, int height) => _Create((uint)width, (uint)height);
