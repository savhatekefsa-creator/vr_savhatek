...
namespace PassthroughCameraSamples
{
    ...
    {
        // META SDK'SIZ UYARLAMA: OVRPermissionsRequester.ScenePermission sabiti yerine string'in
        // kendisi. Projede bu izin zaten RoomScanSync tarafindan isteniyor (ayni deger).
